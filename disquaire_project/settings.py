...
DATABASES = {
    'default': {
        ...
        'NAME': 'diskaire', # le nom de notre base de données créée précédemment
        'USER': 'medard', # attention : remplacez par votre nom d'utilisateur !!
        'PASSWORD': 'planetdark23',
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
